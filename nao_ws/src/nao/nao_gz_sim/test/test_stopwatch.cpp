...
#include <nao_gz_sim/Stopwatch.hpp>
...
void runTimer(nao_gz_sim::Stopwatch & _time)
{
  // Start the timer
...
TEST_F(Stopwatch, Constructor)
{
  ...
  nao_gz_sim::Stopwatch watch2(watch);
  EXPECT_EQ(watch, watch2);

  nao_gz_sim::Stopwatch watch3(std::move(watch2));
...
TEST_F(Stopwatch, EqualOperator)
{
  ...
  nao_gz_sim::Stopwatch watch;
  watch.SetClock(clock);
  nao_gz_sim::Stopwatch watch2;
  watch2.SetClock(clock);
  nao_gz_sim::Stopwatch watch3;
