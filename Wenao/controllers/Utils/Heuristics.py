...
class AStarPlanner:
    ...
    @staticmethod
    def calc_heuristic(n1, n2): # Euclidean
        w = 1.0  # weight of heuristic
        d = w * math.hypot(n1.x - n2.x, n1.y - n2.y)
        return d
    
    # def calc_heuristic(n1, n2): # Manhattan
    #     w = 1.0  # Weight 
    #     d = w * (abs(n1.x - n2.x) + abs(n1.y - n2.y))
    #     return d
    
    # def calc_heuristic(n1, n2): # Chebyshev
    #     w = 1.0 
    #     dx = abs(n1.x - n2.x)
    #     dy = abs(n1.y - n2.y)
    #     d = w * max(dx, dy)
    ...
    # def calc_heuristic(n1, n2): # Octile
    #     w = 1.0 
    #     dx = abs(n1.x - n2.x)
    #     dy = abs(n1.y - n2.y)
    #     d = w * (dx + dy + (math.sqrt(2) - 2) * min(dx, dy))
    #     return d
