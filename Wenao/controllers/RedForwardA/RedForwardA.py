    ...
    def NextMotion(self):
        ...
        match self.AppState:
            case RobotState.INIT:
                ...
                targetAngle_start = Functions.calculate_target_angle(currentBallPosition, currentSelfPosition)                
                turnAngle_start = Functions.calculate_turn_angle(targetAngle_start, robotAngle)

                if robot_distance <= 0.2 and abs(turnAngle_start) < 12:
                    self.AppState = RobotState.BE_A_FORWARD
                    return self.motions.standInit
                
                elif abs(turnAngle_start) > 12:
            ...
            case RobotState.SCORE_GOAL:
                ...
                targetAngle = Functions.calculate_target_angle(self.Supervisor.data["BlueGoalkeeper"], currentSelfPosition)
