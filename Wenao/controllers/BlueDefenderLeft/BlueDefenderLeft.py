...
class SoccerRobot(Robot):
    ...
    def moveToBall(self):
        ...
        robot_position = self.supervisorDataPos["BlueDefenderLeft"]
        ...
        print("Left Defender Robot Position:", robot_position)
        print("Left Defender Ball Position:", ball_position)
        print("Left Defender Distance:", distance)    
        ...
        print("Left Defender Turning Angle:", turn_robot)
